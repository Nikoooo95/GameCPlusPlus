...
#include <thread>
    ...
    namespace basics { namespace internal
    {
        ...
        Android_OpenGLES_Context::Android_OpenGLES_Context(Native_Window & window) : OpenGLES_Context(window)
        {
        ...
        void Android_OpenGLES_Context::suspend ()
        {
            if (initialized)
            {
                available = false;
        ...
        bool Android_OpenGLES_Context::resume ()
        {
            if (initialized)
            {
        ...
        void Android_OpenGLES_Context::finalize ()
        {
            available = false;
        ...
        bool Android_OpenGLES_Context::is_current () const
        {
            if (available)
            {
        ...
        bool Android_OpenGLES_Context::set_sync_swap (bool activated)
        {
            if (available)
            {
        ...
        bool Android_OpenGLES_Context::make_current ()
        {
            if (available)
            {
        ...
        bool Android_OpenGLES_Context::flush_and_display ()
        {
            if (available)
            {
        ...
        bool Android_OpenGLES_Context::initialize_display ()
        {
        ...
        bool Android_OpenGLES_Context::initialize_surface ()
        {
        ...
        bool Android_OpenGLES_Context::initialize_context ()
        {
        ...
        void Android_OpenGLES_Context::finalize_display ()
        {
            if (display != EGL_NO_DISPLAY)
            {
        ...
        void Android_OpenGLES_Context::finalize_surface ()
        {
            if (surface != EGL_NO_SURFACE)
            {
        ...
        void Android_OpenGLES_Context::finalize_context ()
        {
