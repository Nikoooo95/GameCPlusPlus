...
namespace example
{
    ...
    // ---------------------------------------------------------------------------------------------
    /**
     * Este método carga la textura que se mostrará dentro de la intro
     * Si se ha cargado correctamente, se pasa a Fading_In
     */
    ...
    // ---------------------------------------------------------------------------------------------
    /**
     * Este método hace el Fade In de la escena
     *
     */
    ...
    // ---------------------------------------------------------------------------------------------
    /**
     * Este método espera 2 segundos antes de pasar al fade out de la escena
     *
     */
    ...
    // ---------------------------------------------------------------------------------------------
    /**
     * Este método hace el Fade Out de la escena
     *
     */
