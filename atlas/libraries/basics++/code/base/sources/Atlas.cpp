...
namespace basics
{
    ...
    void Atlas::parse (Buffer & slices_data, Graphics_Context::Accessor & context)
    {
        ...
        if (img_tag)
        {
            parse_img (img_tag, context);
        }
    }

    void Atlas::parse_img (rapidxml::xml_node<> * img_tag, Graphics_Context::Accessor & context)
    {
        ...
        if (name_attribute)
        {
            ...
            texture = Texture_2D::create (0, context, name_attribute->value ());
